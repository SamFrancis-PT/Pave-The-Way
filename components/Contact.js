...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <motion.form
        action="https://formsubmit.co/sam@pavetheway.fit"
        method="POST"
        ...
        variants={itemVariants}
      >
        {/* Formsubmit config — no captcha, redirect back to same page */}
        <input type="hidden" name="_captcha" value="false" />
        <input type="hidden" name="_subject" value="New enquiry from Pave The Way website" />
        ...
        <div className="relative">
          <select name="goal" required className={selectClass}>
            <option value="" disabled selected className="bg-black">Goal</option>
        ...
        <div className="relative">
          <select name="experience" required className={selectClass}>
            <option value="" disabled selected className="bg-black">Training Experience</option>
        ...
        <button
          type="submit"
          className="w-full sm:w-auto px-10 py-4 rounded-full bg-white text-black font-semibold text-sm transition-all duration-300 hover:shadow-[0_0_40px_rgba(255,255,255,0.3)] hover:translate-y-[-2px]"
        >
          Send Enquiry
        </button>
      </motion.form>
