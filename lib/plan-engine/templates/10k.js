...
const WEEK_DATA = [
  { wk: 1, block: 'FOUNDATION', vo2: { set: '6 x 400m', rest: '90 sec standing rest', note: 'Learn the effort. Shorter intervals = go harder. Last 2 reps should be noticeably faster than the first.' }, tempo: '2 x 8 min threshold' },
  { wk: 2, block: 'FOUNDATION', vo2: { set: '5 x 800m', rest: '90 sec easy jog rest', note: 'Settle into a sustainable VO2 effort — you should be breathing hard but not falling apart.' }, tempo: '20 min continuous threshold' },
  { wk: 3, block: 'FOUNDATION', vo2: { set: '5 x 800m', rest: '75 sec easy jog rest', note: 'Same session as last week, less rest. If the pace drops more than 10 sec per km rep-to-rep, you started too fast.' }, tempo: null, raceReps: true },
  { wk: 4, block: 'BUILD', vo2: { set: '4 x 600m', rest: '90 sec standing rest', note: 'Cutback week — less volume but maintain the intensity. Each 600m should feel hard from the start.' }, tempo: '25 min threshold with 3 x 30 sec surges', cutback: true },
  { wk: 5, block: 'BUILD', vo2: { set: '3 x 1km', rest: '2 min easy jog rest', note: 'Longer intervals means you can hold slightly less pace than the 400s and 800s. Find a pace you can sustain all three reps.' }, tempo: null, racePaceReps: '2 x 2 km' },
  { wk: 6, block: 'BUILD', vo2: { set: '3 x 1km then 3 x 200m', rest: '2 min rest after each km / 60 sec after each 200m', note: 'Peak VO2 session. The 200s at the end are neuromuscular — push hard on these. Standing rest between 200s is fine.' }, tempo: null, racePaceReps: '4 km continuous' },
  { wk: 7, block: 'SHARPEN', vo2: { set: '5 x 500m', rest: '75 sec easy jog rest', note: 'Sharpening week. Hard but not destroying yourself. Legs should feel live, not wrecked, two days later.' }, tempo: null, racePaceReps: '2 x 1.5 km', taper: true },
