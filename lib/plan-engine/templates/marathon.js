...
const SIXTEEN_WEEK = [
  { wk: 1, block: 'BASE', longKm: 14, vo2: true, mpKm: 0 },
  { wk: 2, block: 'BASE', longKm: 16, vo2: false, mpKm: 0 },
  { wk: 3, block: 'BASE', longKm: 18, vo2: true, mpKm: 0 },
  { wk: 4, block: 'BASE', longKm: 14, vo2: false, mpKm: 0, cutback: true },
  { wk: 5, block: 'BUILD 1', longKm: 20, vo2: true, mpKm: 0 },
  { wk: 6, block: 'BUILD 1', longKm: 22, vo2: false, mpKm: 4 },
  { wk: 7, block: 'BUILD 1', longKm: 24, vo2: true, mpKm: 0 },
  { wk: 8, block: 'BUILD 1', longKm: 18, vo2: false, mpKm: 5, cutback: true },
  { wk: 9, block: 'BUILD 2', longKm: 26, vo2: true, mpKm: 0 },
  { wk: 10, block: 'BUILD 2', longKm: 28, vo2: false, mpKm: 7 },
  { wk: 11, block: 'BUILD 2', longKm: 24, vo2: true, mpKm: 0, cutback: true },
  { wk: 12, block: 'PEAK', longKm: 30, vo2: false, mpKm: 8 },
  { wk: 13, block: 'PEAK', longKm: 32, vo2: false, mpKm: 10 },
  { wk: 14, block: 'TAPER', longKm: 24, vo2: false, mpKm: 5, taperPct: 75 },
  { wk: 15, block: 'TAPER', longKm: 16, vo2: false, mpKm: 0, taperPct: 55 },
  { wk: 16, block: 'RACE', isRaceWeek: true },
];

const TWELVE_WEEK = [
  { wk: 1, block: 'BASE', longKm: 16, vo2: true, mpKm: 0 },
  { wk: 2, block: 'BASE', longKm: 18, vo2: false, mpKm: 0 },
  { wk: 3, block: 'BASE', longKm: 20, vo2: true, mpKm: 0 },
  { wk: 4, block: 'BUILD', longKm: 16, vo2: false, mpKm: 0, cutback: true },
  { wk: 5, block: 'BUILD', longKm: 24, vo2: true, mpKm: 4 },
  { wk: 6, block: 'BUILD', longKm: 26, vo2: false, mpKm: 6 },
  { wk: 7, block: 'BUILD', longKm: 22, vo2: true, mpKm: 0, cutback: true },
  { wk: 8, block: 'BUILD', longKm: 29, vo2: false, mpKm: 8 },
  { wk: 9, block: 'PEAK', longKm: 32, vo2: false, mpKm: 10 },
  { wk: 10, block: 'TAPER', longKm: 24, vo2: false, mpKm: 5, taperPct: 75 },
  { wk: 11, block: 'TAPER', longKm: 16, vo2: false, mpKm: 0, taperPct: 55 },
...
function buildMarathon(answers, zones, raceDate) {
  ...
  const weeks = plan.map((data) => {
    ...
    return buildMarathonWeek(data, days, zones, dateRange);
  });
...
function buildMarathonWeek(data, days, zones, dateRange) {
  const sessions = [];
  const { vo2, block, cutback, taperPct, mpKm, longKm, wk } = data;
  ...
  return {
    ...
    coachNote: getMarathonCoachNote(wk, data),
  };
}
...
function getMarathonCoachNote(wk, data) {
  ...
  if (data.longKm >= 30) return `One of the longest runs of your life this weekend. Fuel and hydrate as if it's race day. Execute the marathon pace block at the end, not the start.`;
